...
function MobileOperationView({
  ...
  return (
    <div className="flex-1 flex flex-col bg-surface-950">
      ...
      <div className="flex items-center gap-2 px-3 py-2.5 border-b border-surface-800/50 bg-surface-900/95 backdrop-blur-sm">
        <button
          onClick={onBack}
...
// ── Operation category grid (desktop) ──
    ...
    <div className="h-full flex flex-col bg-surface-950 overflow-y-auto">
      ...
      <div className="flex-1 flex flex-col px-4 pb-6">
        ...
        <div className="mt-6">
          ...
          <div className="grid grid-cols-2 gap-2.5">
            {OP_CATEGORIES_DESKTOP.slice(0, 4).map((cat) => (
